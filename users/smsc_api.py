...
# login=kupizalog&
# psw=04268390d4ab7741c5e7e461657344befb41204e&
# phones={$user->phone}&mes=Подтверждение на сайте www.kupizalog.kz {$user->code}";
#
SMSC_LOGIN = "kupizalog"			# логин клиента
SMSC_PASSWORD = "04268390d4ab7741c5e7e461657344befb41204e"	# пароль
